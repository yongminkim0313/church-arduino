#!/bin/bash
# TalentNfcReader_JC3245 빌드/업로드 (가이션 JC3248W535C_I_Y)
#
...
#
# 필요 라이브러리: GFX Library for Arduino(1.5+), Adafruit PN532, Adafruit BusIO,
#                  ArduinoJson, NimBLE-Arduino 2.x
...
# PSRAM 은 반드시 켜야 한다 — 화면 버퍼 300KB(320×480×2)를 거기에 잡는다.
...
ARGS=(--fqbn "$FQBN" TalentNfcReader_JC3245)
